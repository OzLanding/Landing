"""
모든 환경(dev / prod)이 공통으로 쓰는 기본 설정.
환경별로 달라지는 값(DEBUG, ALLOWED_HOSTS 등)은 dev.py / prod.py 에서 override 한다.
"""
...
# 프로젝트 루트 (Landing/settings/base.py 기준 3단계 위)
...
DATABASES = {
    "default": {
        ...
        "NAME": os.environ.get("DB_NAME", "landing_db"),
